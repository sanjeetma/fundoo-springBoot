...
public class NoteController {
	...
	public ResponseEntity<String> updateNodeReact(@RequestParam Long id, @RequestBody NoteModel noteModel,
	...
	public ResponseEntity<Response> listLabel(@RequestHeader(name = "token") String token, @RequestParam Long noteId,
	...
	public ResponseEntity<Response> deleteLabelFromNote(@RequestParam Long noteId, @RequestParam Long labelId,
			@RequestHeader String token) {
	...
	public ResponseEntity<LabelModel> addCollaborator(@RequestParam Long noteId, @RequestParam String email,
			@RequestHeader String token) {
	...
	public ResponseEntity<Response> removeCollaborator(@RequestParam Long noteId, @RequestParam String email,
			@RequestHeader String token) {
	...
	public ResponseEntity<List<String>> getCollboratedUserForNote(@RequestParam Long noteId,
			@RequestHeader String token) {
		List<String> collaboratedUsers = noteServiceImplementation.getCollaboratedUserForNotes(noteId, token);
		return new ResponseEntity<List<String>>(collaboratedUsers, HttpStatus.OK);
	}
	...
	public ResponseEntity<Response> addNoteToLabel(@RequestParam Long labelId, @RequestParam Long noteId,
			@RequestHeader String token) {
